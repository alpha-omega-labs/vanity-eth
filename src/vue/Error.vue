<template>
    <div class="panel">
        ...
        <div v-if="error === 'insecure_location'">
            ...
            You are using Vanity-L1 from an unknown website, which could steal your private keys.<br>
            To stay safe, use Vanity-L1 from original Ethereum vanity generator <a href="https://vanity-eth.tk" target="_blank">vanity-eth.tk</a>, or
